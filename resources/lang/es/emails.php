...
return [
	...
	*/
    ...
    'new-booking-text' => 'En breve recibirás una comunicación por parte del propietario/gestor del atraque con las instrucciones para realizar el pago.',
		...
		'new-dock' => 'New Dock!!!',
		'new-dock-intro' => 'A new dock has been created with the following id:',
		'new-dock-text' => 'If you want to update anything on this dock, please proceed to the administration panel by clicking in the following button.',
		'delete-dock' => 'Deleted Dock',
		'delete-dock-text' => 'A dock you own/manage has been deleted. If you want to create a new dock or check any existing dock you own/manage, please proceed by clicking the following button',
	],
